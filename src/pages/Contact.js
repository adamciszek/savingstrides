        ...
        <>
            ...
            <div id="contact" className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24">
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    ...
                    <div
                        className="fixed right-0 top-32 w-1/3 px-8 py-6 bg-black rounded-2xl shadow-lg">
                        <div className="flex flex-col text-white">
                            <div className="mt-5">
                                <h2 className="text-2xl">Send us an Email</h2>
                                <p className="text-gray-400">savingstrides@gmail.com</p>
                            </div>
                            <div className="mt-5">
                                <h2 className="text-2xl mb-4">Follow our Socials</h2>
