...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .send('service_gfhygmq', 'template_r0772gr', templateParams, '8zZiGKytUjcIiqBXn')
            .then(
                (response) => {
    ...
    return (
        <>
            ...
            <div id="contact" className="flex flex-col lg:flex-row justify-center items-start mt-8 w-full bg-white py-12 lg:py-24">
                ...
                {/* Black Section - Email & Social Links */}
                <div
                    className="hidden lg:block lg:absolute lg:top-1/2 lg:transform lg:-translate-y-1/2 lg:right-10 w-2/3 lg:w-1/3 bg-black text-white rounded-2xl shadow-lg p-8 mt-8 lg:mt-0">
                    <div className="flex flex-col">
                        <div className="mb-5">
                            <h2 className="text-2xl font-bold">Send us an Email</h2>
                            <p className="text-gray-400">savingstrides@gmail.com</p>
                        </div>
                        <div>
