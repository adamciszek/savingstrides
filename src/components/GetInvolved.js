...
const GetInvolved = () => {
    return (
        <div className="mt-8 bg-gray-100" id="GetInvolved">
            <section data-aos="fade-up">
                <div className="my-4 py-4">
                        ...
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-black">Find our upcoming events below</h2>
                    </div>
