            ...
            <section data-aos="zoom-in-down">
                ...
                <div className="px-12" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-black rounded-lg shadow-2xl p-3 group flex flex-col h-full">
                            <div className="flex-1 flex justify-center items-center">
                                <img alt="Placeholder for Future Partners" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out max-h-[50%]" src={img4} />
                            </div>
                            <div className="flex-none text-center p-4 h-30">
                                <h2 className="font-semibold my-4 text-2xl">Future Partners</h2>
                                <p className="text-md font-medium">
                                    We’re always looking to expand our network and collaborate with like-minded organizations to make a greater impact in our community.
                                </p>
                            </div>
                        </div>
                    </div>
